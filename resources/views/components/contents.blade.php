<section>
    <div class="max-w-[800px] shadow-lg m-auto">
        ...
        <div class="m-5 mx-auto">
            ...
            <form id="commentForm" method="post" class="bg-white shadow-md rounded px-8 pt-2 pb-8 mb-4">
                <div class="mb-4">
...
<script>
    ...
    async function showcomments() {
        try {
            const response = JSON.parse('<?php echo json_encode($post->comment); ?>');
